...
import com.rmarinov.tempcheck.data.model.RegisterRequest
...
class RegisterViewModel @Inject constructor(
    ...
    fun onRegisterClicked(username: String, password: String) {
        viewModelScope.launch(defaultDispatcher) {
            ...
            runCatching {
                tempRepository.register(RegisterRequest(username, password))
                ...
                _isLoading.postValue(false)
                _error.postValue(Event("Error. The username may be taken. Please try again."))
            }
        }
    }
